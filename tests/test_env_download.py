...
class DownloadTest(unittest.TestCase):
    ...
    @unittest.skipIf("TRAVIS" not in os.environ or os.environ["TRAVIS"] == "false",
                     "This runs only on Travis CI")
    def test_full_download(self):
        ...
        print(os.listdir(dl_path))
        print(os.listdir(os.path.join(dl_path, '2018.12.01')))
